...
import com.dismar.service.config.audit.AuditEventConverter;
import com.dismar.service.domain.PersistentAuditEvent;
...
import static com.dismar.service.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
